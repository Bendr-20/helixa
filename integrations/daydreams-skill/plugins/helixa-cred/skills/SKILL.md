...
| Marginal | 26–50 | Early stage, limited history |
| Qualified | 51–75 | Established, consistent activity |
| Prime | 76–90 | High quality, trusted |
| Preferred | 91–100 | Elite reputation |
...
const CredTier = z.enum(['Junk', 'Marginal', 'Qualified', 'Prime', 'Preferred']);
