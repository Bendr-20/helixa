  ...
  return (
    <div className="py-12">
      <div className="container max-w-5xl">
        ...
        {/* Global Stats */}
        <div className="grid grid-cols-2 md:grid-cols-4 mb-16" style={{ gap: '1.25rem' }}>
        ...
        {authenticated && address && (
          <div className="card p-4 mb-16 flex items-center justify-between">
                        ...
                        <div className="flex-shrink-0 ml-2 text-right">
                          ...
                          {a.stakedAmount && parseFloat(a.stakedAmount) > 0 && (
                            <div className="text-[10px] font-mono text-mint mt-0.5">
                              <svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor" className="inline-block mr-0.5 -mt-px opacity-70"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4" fill="none" stroke="currentColor" strokeWidth="2.5"/></svg>
