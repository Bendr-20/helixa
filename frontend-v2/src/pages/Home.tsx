      ...
      <section className="home-section">
        <div className="home-section-inner">
          ...
          <div className="home-steps">
            {[
              { num: '1', title: 'Sign In', desc: 'Sign in with email, social login, or wallet. There is no Helixa platform fee right now.' },
        ...
        <div className="home-section-inner">
          ...
          <div className="home-features-grid">
            {[
              ...
              { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35"/><path d="M11 8v6"/><path d="M8 11h6"/></svg>, title: 'Agent Discovery', desc: 'Found by any AI. MCP, A2A, OASF, x402 — every major agent protocol, one endpoint.' },
              { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>, title: 'ERC-8004 Native', desc: 'Auto-registered on the canonical Identity Registry. Your agent is discoverable across the entire 8004 ecosystem.' },
            ].map((feature, i) => (
              <motion.div
                key={i}
