import{bn as B,aP as P,aU as m,cU as F,aR as t,cV as z,bl as D,bf as v}from"./index-BIIr9Zi4.js";import{p as V}from"./CopyableText-ChtfBWx4-Ctw1vTiV.js";import{n as C}from"./ScreenLayout-Ce16-u0i-DHLa5wS9.js";import{i as R}from"./InfoBanner-DkQEPd77-Do2PTAIz.js";import{y as M,c as Y,p as q}from"./SelectSourceAsset-BSIZrvmo-DaGLzy_2.js";import{r as A}from"./chevron-down-C9e8JkFh.js";import{c as H}from"./createLucideIcon-BWu0ydMA.js";import{H as K}from"./hourglass-C6oTDxwh.js";import{C as N}from"./check-D5uJ-pvI.js";import{C as S}from"./circle-x-CwG1mFN1.js";import"./copy-CSQsgy2k.js";import"./ModalHeader-YbJk-YIQ-C-N0i6VD.js";import"./Screen-CdOj1bUg-4yeSP8XK.js";import"./index-Dq_xe9dz-DEotILZS.js";const O=[["path",{d:"m16 11 2 2 4-4",key:"9rsbq5"}],["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}]],X=H("user-check",O),G=e=>{try{return e.location.origin}catch{return}},J=({data:e,onClose:i})=>t.jsx(C,{showClose:!0,onClose:i,title:"Initiate bank transfer",subtitle:"Use the details below to complete a bank transfer from your bank.",primaryCta:{label:"Done",onClick:i},watermark:!1,footerText:"Exchange rates and fees are set when you authorize and determine the amount you receive. You'll see the applicable rates and fees for your transaction separately",children:t.jsx(Q,{children:(z[e.deposit_instructions.asset]||[]).map((([u,f],y)=>{let d=e.deposit_instructions[u];if(!d||Array.isArray(d))return null;let r=u==="asset"?d.toUpperCase():d,h=r.length>100?`${r.slice(0,9)}...${r.slice(-9)}`:r;return t.jsxs(Z,{children:[t.jsx(ee,{children:f}),t.jsx(V,{value:r,includeChildren:D.isMobile,children:t.jsx(te,{children:h})})]},y)}))})});let Q=v.ol`
