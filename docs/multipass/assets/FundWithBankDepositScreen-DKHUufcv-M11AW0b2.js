import{dy as B,cZ as F,d2 as m,f3 as P,c$ as t,f4 as z,dw as D,dq as v}from"./index-CXAb4p9O.js";import{p as V}from"./CopyableText-ChtfBWx4-B_Yyekvb.js";import{n as C}from"./ScreenLayout-Ce16-u0i-CCkNzu_F.js";import{i as q}from"./InfoBanner-DkQEPd77-C6Oj6isf.js";import{y as M,c as R,p as Y}from"./SelectSourceAsset-BSIZrvmo-Dl95gttn.js";import{r as A}from"./chevron-down--6_55zYx.js";import{c as H}from"./createLucideIcon-DMurkbtz.js";import{H as K}from"./hourglass-BIP4IRjw.js";import{C as N}from"./check-BoN0jUXd.js";import{C as S}from"./circle-x-BoUYBEXb.js";import"./copy-BArgo9Kg.js";import"./ModalHeader-YbJk-YIQ-Cmmy47FY.js";import"./Screen-CdOj1bUg-CgMfUZkp.js";import"./index-Dq_xe9dz-Dt1oImY4.js";const O=[["path",{d:"m16 11 2 2 4-4",key:"9rsbq5"}],["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}]],X=H("user-check",O),Z=e=>{try{return e.location.origin}catch{return}},G=({data:e,onClose:i})=>t.jsx(C,{showClose:!0,onClose:i,title:"Initiate bank transfer",subtitle:"Use the details below to complete a bank transfer from your bank.",primaryCta:{label:"Done",onClick:i},watermark:!1,footerText:"Exchange rates and fees are set when you authorize and determine the amount you receive. You'll see the applicable rates and fees for your transaction separately",children:t.jsx(J,{children:(z[e.deposit_instructions.asset]||[]).map((([u,f],y)=>{let d=e.deposit_instructions[u];if(!d||Array.isArray(d))return null;let r=u==="asset"?d.toUpperCase():d,h=r.length>100?`${r.slice(0,9)}...${r.slice(-9)}`:r;return t.jsxs(Q,{children:[t.jsx(ee,{children:f}),t.jsx(V,{value:r,includeChildren:D.isMobile,children:t.jsx(te,{children:h})})]},y)}))})});let J=v.ol`
