...
`;function Cr({quote:e,selectedCurrency:r,selectedChain:n,destinationSymbol:o}){let[i,l]=m.useState(!1),a=r.symbol.toUpperCase(),u=n.displayName,s=m.useRef(null);return t.jsxs(wr,{children:[t.jsxs(Er,{onClick:m.useCallback((()=>{let c=document.getElementById("privy-modal-content");c&&(s.current&&clearTimeout(s.current),c.style.transition="none",s.current=setTimeout((()=>{c.style.transition="",s.current=null}),160)),l((p=>!p))}),[]),children:[t.jsxs(_r,{children:[r.logoURI&&t.jsx(se,{src:r.logoURI,alt:a,style:{width:"2rem",height:"2rem"}}),n.iconUrl&&t.jsx(kr,{src:n.iconUrl,alt:u})]}),t.jsxs(Tr,{children:[t.jsx(jr,{children:"You send"}),t.jsxs(Sr,{children:[a," on ",u]})]}),t.jsx(Nr,{children:t.jsx(i?Be:Ie,{size:16})})]}),t.jsx(Ir,{$expanded:i,children:t.jsx(Or,{children:t.jsxs(Ur,{children:[e.indicative_rate&&t.jsxs(A,{children:[t.jsx(D,{children:"Conversion rate"}),t.jsxs(I,{style:{display:"flex",alignItems:"center",gap:"0.25rem"},children:[Qe(e.indicative_rate,a,o.toUpperCase()),t.jsx(Rr,{content:"Estimated rate based on current market conditions. Final execution price may vary depending on transfer size and routing."})]})]}),t.jsxs(A,{children:[t.jsx(D,{children:"Max slippage"}),t.jsxs(I,{children:[(e.slippage_bps/100).toFixed(1),"%"]})]}),t.jsxs(A,{children:[t.jsx(D,{children:"Refund address"}),t.jsx(I,{children:t.jsx(De,{value:e.refund_address,iconOnly:!0,iconSize:11,children:he(e.refund_address,4,4)})})]})]})})}),t.jsxs(Ar,{children:[t.jsx(R,{size:16,color:"var(--privy-color-icon-muted)",style:{flexShrink:0}}),t.jsxs(Dr,{children:["Only send ",t.jsx("strong",{children:a})," on ",t.jsx("strong",{children:u}),". Other assets may be lost."]})]})]})}let wr=d.div`
  border-radius: var(--privy-border-radius-md);
