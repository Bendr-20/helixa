...
`,Lr={CREDIT_DEBIT_CARD:"Credit / debit card",APPLE_PAY:"Apple Pay",GOOGLE_PAY:"Google Pay",BANK:"Bank transfer",BANK_TRANSFER:"Bank transfer",SEPA:"SEPA",PIX:"PIX",STRIPE_LINK:"Link"},Ir=e=>Lr[e]??e.replace(/_/g," ").toLowerCase().replace(/^\w/,(t=>t.toUpperCase())),Tr={CREDIT_DEBIT_CARD:o.jsx(q,{size:20}),APPLE_PAY:o.jsx(Ue,{width:20,height:20}),GOOGLE_PAY:o.jsx(Re,{width:20,height:20}),BANK:o.jsx(Y,{size:20}),BANK_TRANSFER:o.jsx(Y,{size:20}),SEPA:o.jsx(Y,{size:20}),PIX:o.jsx(Y,{size:20}),STRIPE_LINK:o.jsx(re,{size:20})},$r=e=>Tr[e]??o.jsx(q,{size:20});const Mr=({onClose:e,onSelectPaymentMethod:t,quotes:r,isLoading:n})=>o.jsx(C,{showClose:!0,onClose:e,title:"Select payment method",subtitle:"Choose how you'd like to pay",watermark:!0,children:o.jsx(Nr,{children:r.map(((i,s)=>{let l=i.payment_method_category??i.payment_method;return o.jsx(Dr,{onClick:()=>t(i),disabled:n,children:o.jsxs(qr,{children:[o.jsx(zr,{children:$r(l)}),o.jsx(Rr,{children:o.jsx(Ur,{children:Ir(l)})})]})},`${i.provider}-${i.payment_method}-${s}`)}))})});let Nr=h.div`
  display: flex;
  flex-direction: column;
  gap: 0.75rem;
  width: 100%;
