...
|--------|--------|--------|
| Activity (txs, interactions) | 20% | Onchain |
| Trait completeness | 15% | 8004 metadata |
| Verification status | 15% | Helixa mint / Coinbase EAS |
| Coinbase Verified | 15% | EAS attestation |
| Age | 10% | Creation timestamp |
| Narrative (origin, mission, lore) | 10% | 8004 metadata |
| MintOrigin (human vs agent vs API) | 10% | Helixa contract |
| Soulbound | 5% | 8004 metadata |
