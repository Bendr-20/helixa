import{j as e}from"./vendor-wallet-BNrGO_Lv.js";import{a$ as p,r as P,d as r}from"./index-C10AAsIt.js";import{p as S,v as u,h as v}from"./WalletLink--05Hzo2b-CYBKP7RN.js";import{c as g}from"./ethers-D1WT71Ay-CsgH_Tvg.js";import{d as f}from"./Layouts-BlFm53ED-Br6wN8iF.js";import{F as I}from"./ChevronDownIcon-wDivZlPD.js";import{r as d}from"./vendor-react-D6Ns6jNv.js";const h=({label:i,children:n,valueStyles:t})=>e.jsxs(C,{children:[e.jsx("div",{children:i}),e.jsx(B,{style:{...t},children:n})]});let C=r.div`
  display: flex;
  align-items: center;
...
`;const Z=({from:i,to:n,txn:t,transactionInfo:o,tokenPrice:l,gas:c,tokenSymbol:x})=>{let w=BigInt(t?.value||0);return e.jsx(T,{...P().render.standalone?{defaultValue:"details"}:{},children:e.jsxs($,{value:"details",children:[e.jsx(z,{children:e.jsxs(G,{children:[e.jsx("div",{children:o?.title||"Details"}),e.jsx(J,{children:e.jsx(S,{weiQuantities:[w],tokenPrice:l,tokenSymbol:x})})]})}),e.jsxs(E,{children:[e.jsx(h,{label:"From",children:e.jsx(u,{walletAddress:i,chainId:t.chainId||p,chainType:"ethereum"})}),e.jsx(h,{label:"To",children:e.jsx(u,{walletAddress:n,chainId:t.chainId||p,chainType:"ethereum"})}),o&&o.action&&e.jsx(h,{label:"Action",children:o.action}),c&&e.jsx(A,{value:t.value,gas:c,tokenPrice:l,tokenSymbol:x})]}),e.jsx(Q,{children:({isActive:k})=>e.jsx(F,{value:t.value,displayFee:k,gas:c||"0x0",tokenPrice:l,tokenSymbol:x})})]})})};let G=r.div`
  display: flex;
  flex-direction: row;
  justify-content: space-between;
`,J=r.div`
