import{j as s}from"./vendor-wallet-iWeBopzN.js";import{c}from"./index-D-8GrUwK.js";let d=c.a`
  && {
...
`;const u=({size:r="md",variant:e="navigation",disabled:o=!1,as:i,children:a,onClick:t,...l})=>s.jsx(d,{as:i,$size:r,$variant:e,$disabled:o,onClick:n=>{o?n.preventDefault():t?.(n)},...l,children:a});export{u as n};
